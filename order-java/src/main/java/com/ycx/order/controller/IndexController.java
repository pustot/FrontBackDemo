package com.ycx.order.controller;

import com.ycx.order.common.limit.RedisLimit;
import com.ycx.order.common.stockWithRedis.StockWithRedis;
...
public class IndexController {
    ...
    @Autowired
    public IndexController(OrderService orderService, StockService stockService) {
     ...
     * seems not sending properly in kafka
     * @param sid
     */
